...
export default function ChooseCountryRegion() {
    ...
    return (
        ...
        <header className={'container mx-auto ps-6 pe-6'}>
            <div className={'h-14 flex items-center border-b border-gray-400'}><NavigationLink href={'/choose-country-region'} className={'text-xl font-semibold'}>Choose Your Country or Region</NavigationLink> </div>
        </header>
